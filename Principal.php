...
<li><a href="RegistrosUsuarios.php"><span class="icon-folder"></span>Usuario</a></li>
</li>	
</ul>
<li><a href="Buscar.php"><span class="icon-search"></span> Consultar</a></li>
<li><a href="Login.php"><span class="icon-off"></span> Cerrar Sesiòn</a></li>
 <!-- <li><a href=""><span class="user"><?php //echo $_SESSION['usuario'];?></span></a></li> -->
 <label class="log"><strong>"SITT</strong>(Sistema de Informacion de Tesis y Tesinas)"</label>
<right><li style="color:#fff; cursor:default; padding: 15px 5px; ">Administrador</</li></right>
</ul>
</nav>
</header>
<div class="row">
