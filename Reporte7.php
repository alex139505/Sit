...
$this->cell(89, 10, 'Titulo', 1 ,0, 'C', 0);
$this->cell(11, 10, 'T.D', 1 ,0, 'C', 0);
$this->cell(20, 10, 'Fecha', 1 ,0, 'C', 0);
$this->cell(8, 10, utf8_decode('Año'), 1 ,0, 'C', 0);
...
$consult=("SELECT concat( egresado.nombre, ' ', egresado.apellido_paterno, ' ', egresado.apellido_materno ) AS NombreAlumno, titulo, fechaexamen, tipo_documento, old, periodo, nombre_carrera, nombre_especialidad, concat( Presi.nombre_profesor, ' ', Presi.apellido_paterno, ' ', Presi.apellido_materno ) AS Presidente, concat( Secre.nombre_profesor, ' ', Secre.apellido_paterno, ' ', Secre.apellido_materno ) AS Secretario, concat( Voc.nombre_profesor, ' ', Voc.apellido_paterno, ' ', Voc.apellido_materno ) AS vocal
...
$current_y = $pdf->GetY();
$current_x = $pdf->GetX();
$cell_width = 89;  //define cell width
$cell_height=35;    //define cell height
$pdf->MultiCell( 89, 5, $row['titulo'],1,1,'J'); 
$current_x+=$cell_width;                           //calculate position for next cell
$pdf->SetXY($current_x, $current_y); 
$pdf->cell(11, 10, $row['tipo_documento'], 1 , 0);
$pdf->cell(20, 10, $row['fechaexamen'], 1 , 0);
$pdf->cell(8, 10, $row['old'], 1 , 0);
